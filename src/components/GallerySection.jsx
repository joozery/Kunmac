...
const CarModelCard = ({ model, onBookingClick }) => {
  return (
    <div className="bg-gray-900/60 backdrop-blur-lg border-2 border-yellow-400/40 rounded-2xl overflow-hidden luxury-shadow flex flex-col h-full thai-pattern">
...
const GallerySection = ({ carModels, onBookingClick }) => {
  ...
  return (
    <section id="รถของเรา" className="py-20 bg-gradient-to-b from-gray-900/80 to-black thai-pattern">
      <div className="container mx-auto px-4">
        ...
        {isMobile ? (
          ...
          >
            ...
            <div className="swiper-button-prev-custom absolute left-2 top-1/2 z-10 -translate-y-1/2 cursor-pointer p-2 bg-black/50 rounded-full text-yellow-400 hover:bg-black/70 transition-colors">
              <ChevronLeft size={28} />
            </div>
            <div className="swiper-button-next-custom absolute right-2 top-1/2 z-10 -translate-y-1/2 cursor-pointer p-2 bg-black/50 rounded-full text-yellow-400 hover:bg-black/70 transition-colors">
